export const ru = {
  ...
  brandTagline1: "Управление бизнесом",
  brandTagline2: "без границ.",
  brandDescription:
    "Полная система для управления запасами, продажами, услугами, записью на приём и сотрудниками — разработана для регионов с ограниченным подключением.",
  brandFeature1: "Работает на 100% офлайн — интернет не требуется",
  brandFeature2: "Ваши данные хранятся локально, всегда под вашим контролем",
  ...
  // User management
  deactivateUser: "Деактивировать пользователя — блокирует вход",
  activateUser: "Активировать пользователя — разрешает вход снова",
  ...
  machineCodeHelp: "Поделитесь этим кодом с поставщиком программного обеспечения, чтобы получить лицензионный ключ.",
  enterLicenseKey: "Введите лицензионный ключ",
  activateLicense: "Активировать лицензию",
  activating: "Активация...",
  contactProvider: "Нет лицензионного ключа? Посетите elcofreapp.com или отправьте код своей машины через WhatsApp на +1 (857) 312-4946, чтобы получить его.",
  clockTamperedError: "Обнаружена ошибка системной даты. Пожалуйста, исправьте системные часы и обратитесь в службу поддержки.",
  licenseExpiredError: "Срок действия вашей лицензии истёк. Введите новый лицензионный ключ для продолжения.",
};
